...
cost_burdened <- renter %>% 
  ...
  dplyr::mutate(perc = paste0(sprintf("%4.0f", share * 100))) # adds a percentage column to the cost burdened share
...
## Plot 2
This plot displays all races/ethnicities who are cost burdened. This is defined by anyone paying 30% or more of their income for their rent expense.
```{r echo=FALSE, fig.height=10, fig.width=20, warning=FALSE}
...
writeData(wb, "Cost Burdened (AAPI)", cost_burdened)
writeData(wb, "Cost Burdened (All Race)", cost_burdened_all_race)
