...
```{r}
static_column_chart(depress_anxiety, x='symptoms',y='mean_share', fill= 'select_characteristics')

```

```{r}
static_column_chart(depress_anxiety, x='symptoms',y='mean_total', fill= 'select_characteristics')
