...
header-includes:
  ...
  - \usepackage{fancyhdr}
   ...
   \fancyhead[C]{}
   \fancyhead[L]{\includegraphics{trends-header.png}}
   \fancyhead[R]{}
...
```{r tribal-groupings-chart, echo=FALSE, fig.alt="Bar chart with the numnber of people by Tribal Grouping with more than 1000 people in the Puget Sound Region", fig.height = 5, fig.width = 8}
tribal_groupings_chart
```

\begin{flushleft}
To view the full data set from the US Census, please go to: 
\begin{scriptsize}
\url{https://data.census.gov/cedsci/table?q=B02014&g=0500000US53033,53035,53053,53061&tid=ACSDT5Y2020.B02014&hidePreview=true}
\end{scriptsize}
...
poverty_chart <- create_static_column_chart(t = data %>% filter(concept == "Poverty"),
                                            ...
                                            source = "Source: U.S. Census Bureau, ACS 1-Year Estimates, tables B17020H, B17020C",                                                                         color = "gnbopgy_5") + 
  ggplot2::theme(axis.text.y = ggplot2::element_blank(),
                 axis.text = ggplot2::element_text(family="Poppins",
                                      size=11,
                                      color="#2f3030"),
